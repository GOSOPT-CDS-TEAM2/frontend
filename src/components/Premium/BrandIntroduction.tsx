...
import { 바비브라운영상, 숨Img, 헤라Img } from '../../assets/image';
...
const BrandIntroduction = () => {
  ...
  return (
    <St.BrandIntroContainer>
      <St.AdVideo>
        <video ref={videoRef} muted loop onClick={handleVideoClick}>
      ...
      <St.CustomSwiper
        ...
        <SwiperSlide>
          ...
          <St.SwiperComment>오랜 연구와 진보된 발효과학, 숨37</St.SwiperComment>
        </SwiperSlide>
        <SwiperSlide>
          <img src={헤라Img} alt="헤라 브랜드 소개" />
          <St.SwiperComment>CONTEMPORARY 시그니처</St.SwiperComment>
        </SwiperSlide>
